...
func adjustColors(image: UIImage) -> UIImage {
    ...
    if let currentFilter = CIFilter(name: "CIColorControls") {
        ...
        currentFilter.setValue(8, forKey: kCIInputContrastKey) //previous 1.5
...
func crop(image: UIImage, rectangle: VNRectangleObservation) -> UIImage? {
    ...
    let fromRect = CGRect(x: x, y: y, width: (width+1), height: (height+1))
...
func preProcess(image: UIImage) -> UIImage {
    ...
    saveImageToDocumentDirectory(image: grayScaleImage)
...
func saveImageToDocumentDirectory(image: UIImage ) {
    ...
    let fileName = "image.png" // name of the image to be saved
